...
class UniversityServiceTest {
    ...
    @Test
    @DisplayName("Should return institution from repository")
    void testGetInstitution() {
        ...
        when(universityRepository.findAllActive()).thenReturn(List.of(u));

        University inst = universityService.getInstitution();
        assertNotNull(inst);
        assertEquals("dypiu", inst.getCode());
        assertEquals("D Y Patil International University Akurdi Pune", inst.getName());
    }
